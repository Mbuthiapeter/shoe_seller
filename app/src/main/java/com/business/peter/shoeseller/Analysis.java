 ...
 */
public class Analysis extends ListActivity implements View.OnClickListener, AdapterView.OnItemSelectedListener {
    // Progress Dialog
    ...
    private static final String TAG_SHOES = "shoes_analysis";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        new LoadGeneralAnalysis(userId).execute();
        ...
        from_date.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                // date picker dialog
                dpd = new DatePickerDialog(Analysis.this,
     ...
     * */
    class LoadGeneralAnalysis extends AsyncTask<String, Void, Boolean> {
        String userId;

        public LoadGeneralAnalysis(String userId){
            this.userId= userId;
        }
        /**
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(Analysis.this);
        ...
        protected Boolean doInBackground(String... urls) {
            ...
            final JSONObject json = jParser.makeHttpRequest(url_all_shoes +"sales_analysis.php", "GET", dataToSend);
            // Check your log cat for JSON reponse
            Log.d("Sold shoes analysis", json.toString());
            ...
            try {
                ...
                if (success == 1) {
                    ...
                    for (int i = 0; i < sold_shoes.length(); i++) {
                        ...
                        soldShoe.setLayout(analysis_status);
